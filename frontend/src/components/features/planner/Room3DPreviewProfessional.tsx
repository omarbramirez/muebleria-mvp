 ...
 */
const Room3DPreviewProfessional = forwardRef<OpeningMethods, Room3DPreviewProps>(
...
Room3DPreviewProfessional.displayName = "Room3DPreview";
export default Room3DPreviewProfessional;
