        ...
        <div className=" flex flex-col select-none bg-[#FAFAF8] h-screen overflow-hidden relative">
            ...
            <div className="absolute top-0 z-10 flex flex-row px-5 py-4 justify-center w-full gap-4 pointer-events-none">
                <div className="min-w-[300px] pointer-events-auto bg-white/80 backdrop-blur-md p-1 rounded-lg shadow-sm border border-gray-200 flex gap-1 flex-row items-center justify-center relative">
                    ...
                    {/* Botón de Ayuda para reabrir el modal */}
                    <button
                        onClick={() => setIsWelcomeOpen(true)}
                        className="absolute right-[-40px] bg-white p-2 rounded-full shadow-sm border border-gray-200 text-gray-500 hover:text-blue-600 transition-colors"
